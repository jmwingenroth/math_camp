...
By the identities 
\begin{align*}
    \mathcal M_{\X}&=\mathcal I_n-\X(\X\tp\X)^{-1}\X\tp\\
    \mathcal M_{\X}-\mathcal M_{\X}\tp&=\I_n-\X(\X\tp\X)^{-1}\X\tp-(\I_n-\X(\X\tp\X)^{-1}\X\tp)\tp\\
    &=\I_n-\X(\X\tp\X)^{-1}\X\tp-\I_n\tp+(\X(\X\tp\X)^{-1}\X\tp)\tp&\text{by Theorem 2(a)}\\
    &=\I_n-\X(\X\tp\X)^{-1}\X\tp-\I_n+(\X(\X\tp\X)^{-1}\X\tp)\tp&\text{by }\I_n\tp=\I_n\\
    &=-\X(\X\tp\X)^{-1}\X\tp+(\X(\X\tp\X)^{-1}\X\tp)\tp&\text{by Definition 15}\\
    &=-\X(\X\tp\X)^{-1}\X\tp+(\X\tp)\tp((\X\tp\X)^{-1})\tp\X\tp&\text{by Theorem 2(c)}\\
    &=-\X(\X\tp\X)^{-1}\X\tp+\X((\X\tp\X)^{-1})\tp\X\tp&\text{by }(A\tp)\tp=A\\
    &=-\X(\X\tp\X)^{-1}\X\tp+\X((\X\tp\X)\tp)^{-1}\X\tp&\text{by Theorem 5.3}\\
    &=-\X(\X\tp\X)^{-1}\X\tp+\X((\X\tp(\X\tp)\tp)\tp)^{-1}\X\tp\\
    &=-\X(\X\tp\X)^{-1}\X\tp+\X((\X\tp\X)\tp)^{-1}\X\tp\\
    &=\mathbf0_n
\end{align*}
and the definition of symmetry, the matrix $\mathcal M_{\X}$ is symmetric.
\subsubsection*{Idempotency}

To show that $\mathcal M_{\X}$ is idempotent, let $\mathbf{A} = \I_n$ and $\mathbf{B} = \X(\X\tp\X)^{-1}\X\tp$, so that $\mathcal M_{\X} = \mathbf{A} - \mathbf{B}$.

$\mathbf{A}^2 = (\I_n)^2 = \I = \mathbf{A}$, 

$\mathbf{A}\mathbf{B} = \I_n\X(\X\tp\X)^{-1}\X\tp= \X(\X\tp\X)^{-1}\X\tp = \mathbf{B}$,
and $\mathbf{B}^2 = \X(\X\tp\X)^{-1}\X\tp\X(\X\tp\X)^{-1}\X\tp = \X(\X\tp\X)^{-1}\X\tp = \mathbf{B}$.

By the distributive property, $\mathcal M_{\X}^2 = (\mathbf{A} - \mathbf{B})^2 = \mathbf{A}^2 - 2\mathbf{AB} + \mathbf{B}^2 = \mathbf{A} - 2\mathbf{B} + \mathbf{B} = \mathbf{A} - \mathbf{B} = \mathcal M_{\X}$.
